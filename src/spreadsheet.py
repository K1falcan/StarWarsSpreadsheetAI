"""Turn swapi.info data into a formatted multi-sheet Excel workbook."""
...
def build_workbook(client: SwapiClient, data: Dict[str, List[Dict[str, Any]]]) -> Workbook:
    ...
    sheets = [
        ("Characters", CHARACTER_COLUMNS, data["people"]),
        ("Planets", PLANET_COLUMNS, data["planets"]),
        ("Species", SPECIES_COLUMNS, data["species"]),
        ("Starships", STARSHIP_COLUMNS, data["starships"]),
        ("Vehicles", VEHICLE_COLUMNS, data["vehicles"]),
